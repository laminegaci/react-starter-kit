...
import avatarImage from '@/assets/avatar-profile-man.png';
                        ...
                        <tbody>
                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                    <img
                                        ...
                                        src="/images/avatar-profile-man.png"
                                        alt="User avatar"
                                        />
                                    <div className="ps-3">
                                        <div className="text-base font-semibold">Neillll Sims</div>
                            ...
                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <th scope="row" className="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <img className="w-10 h-10 rounded-full" src="/images/avatar-profile-man.png" alt="Jese image" />
                                    <div className="ps-3">
